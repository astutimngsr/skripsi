<div class="row" style="margin: 0;">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div><?=  $this->session->flashdata('buatAkunLogin') ?></div>
            <div><?=  $this->session->flashdata('editAkunLogin') ?></div>
            <div><?=  $this->session->flashdata('hapusAkunLogin') ?></div>
            <div class="card-body">
            ...
            <div class="modal fade" id="verifikasi1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <?php echo form_open_multipart('superadmin/buatAkunLogin/'); ?>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" style="font-size: 13px;" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Save changes button-->
                            <button id="multiPengajuan" type="button" class="btn btn-danger btn-md pull-right" style="font-size: 13px;" data-toggle="modal" data-target="#hapus_akun_<?= $data[$i]['id_admin']?>">
                                Hapus Akun
                            </button>
                            <div class="modal fade" id="hapus_akun_<?= $data[$i]['id_admin']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <?php echo form_open_multipart('superadmin/hapusAkunLogin/'.$data[$i]['id_admin']); ?>
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" >
                            ...
                            <button id="multiPengajuan" type="button" class="btn btn-info btn-md pull-right" style="font-size: 13px;" data-toggle="modal" data-target="#verifikasi_edit<?= $data[$i]['id_admin'] ?>">
                                Edit Akun
                            </button>
                            <div class="modal fade" id="verifikasi_edit<?= $data[$i]['id_admin'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <?php echo form_open_multipart('superadmin/editAkunLogin/'.$data[$i]['id_admin']); ?>
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" >
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input required name="edit_name" id="edit_name" type="text" class="form-control" value="<?= $data[$i]['name'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>NIP</label>
